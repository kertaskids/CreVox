...
namespace Skill.Editor
{
    public static class Builder
    {
        ...
        public static void Build(Skill.Editor.IO.SerializedData saveData, string localDir, string name)
        {
            ValidateGenerator();
            _Generator.Reset();
        ...
        private static void CreateFile(Skill.CodeGeneration.ICodeGenerator generator, string localDir, string name)
        {
            ...
            //else if (System.IO.File.Exists(userFilename) && !System.IO.Path.GetFileNameWithoutExtension(userFilename).Equals(System.IO.Path.GetFileNameWithoutExtension(designerfilename), System.StringComparison.OrdinalIgnoreCase))
            //{
            //    System.IO.File.Delete(userFilename);
            //}
            writer.Close();
