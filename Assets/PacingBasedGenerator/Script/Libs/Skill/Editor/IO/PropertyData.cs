...
namespace Skill.Editor.IO
{
    ...
    public abstract class PropertyData : IXmlElementSerializable
    {
        ...
        /// <summary>  Initial value of property </summary>
        ...
        public XmlElement ToXmlElement()
        {
            ...
            p.SetAttributeValue("InitialValue", InitialValue);
        ...
        public void Load(XmlElement e)
        {
            ...
            this.InitialValue = e.GetAttributeValueAsString("InitialValue", string.Empty);
        ...
        public string GetCast()
        {
            if (SafeMemory && !IsArray)
            {
                if (PrimitiveType == PrimitiveDataType.Integer)
                    ...
                    return "(bool)";
                else if (PrimitiveType == PrimitiveDataType.UInt)
                    return "(uint)";
                else if (PrimitiveType == PrimitiveDataType.Long)
                    return "(long)";
                else if (PrimitiveType == PrimitiveDataType.ULong)
                    return "(ulong)";
            }
            return string.Empty;
        }
    ...
    public enum SerializableReferenceType
    {
        Class,
        Struct,
        Enum
    ...
    /// A property of type Savable class
    /// </summary>
    public class ReferencePropertyData : PropertyData
    {
        /// <summary>
        /// Type of property
        /// </summary>
        public override PropertyType Type { get { return PropertyType.Reference; } }

        /// <summary> Name of class that this property refer to </summary>
        public string ClassName { get; set; }

        /// <summary> type of refrence </summary>
        public SerializableReferenceType ReferenceType { get; set; }

        /// <summary>
        /// Create a ClassProperty
        /// </summary>
        public ReferencePropertyData()
            : base("NewClassProperty")
        {
            ClassName = "Skill.Framework.";
            ReferenceType = SerializableReferenceType.Class;
        }

        protected override void WriteAttributes(XmlElement e)
        {
            e.SetAttributeValue("ClassName", this.ClassName);
            e.SetAttributeValue("RefType", (int)ReferenceType);
            base.WriteAttributes(e);
        }

        protected override void ReadAttributes(XmlElement e)
        {
            this.ReferenceType = e.GetAttributeValueAsEnum("RefType", SerializableReferenceType.Class);
            this.ClassName = e.GetAttributeValueAsString("ClassName", "");
            base.ReadAttributes(e);
        }
