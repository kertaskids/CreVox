...
namespace Skill.Editor.IO
{
    ...
    /// </summary>
    public class SerializedData : ClassData
    {
        public static SerializedData GeneratingInstance { get; set; }
        ...
        /// <summary> Is partial class </summary>
        ...
        {
            IsPartial = e.GetAttributeValueAsBoolean("IsPartial", false);
        ...
        {
            e.SetAttributeValue("IsPartial", IsPartial);
