...
namespace Skill.Editor.IO
{
    ...
    public class SerializedDataEditorWindow : EditorWindow
    {
        #region SaveDataEditorWindow
        private static SerializedDataEditorWindow _Instance;
        public static SerializedDataEditorWindow Instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = ScriptableObject.CreateInstance<SerializedDataEditorWindow>();
                return _Instance;
            }
        }
        ...
        public SerializedDataEditorWindow()
        {
        ...
        private Button _BtnAddReferenceProperty;
        ...
        private void CreateUI()
        {
            ...
            _BtnAddReferenceProperty = new Button() { Height = buttonHeight, Margin = buttonMargin };
            _BtnAddReferenceProperty.Content.tooltip = "add reference property";
            _PropertyButtonsPanel.Controls.Add(_BtnAddReferenceProperty);
            ...
            _BtnAddReferenceProperty.Click += _BtnAddReferenceProperty_Click;
        ...
        void _BtnAddClassProperty_Click(object sender, System.EventArgs e) { AddProperty(PropertyType.Class); }
        void _BtnAddValueProperty_Click(object sender, System.EventArgs e) { AddProperty(PropertyType.Primitive); }
        void _BtnAddReferenceProperty_Click(object sender, System.EventArgs e) { AddProperty(PropertyType.Reference); }
        ...
        private void RefreshStyles()
        {
            if (_RefreshStyles)
            {
                ...
                _BtnAddReferenceProperty.Content.image = Skill.Editor.Resources.UITextures.Icons.Reference;
        ...
        {
            SerializedDataEditorWindow Editor { get; }
            void UpdateText();
        }
        ...
        class ClassDataListItem : Label, IListItem, IPropertyContainer
        {
            ...
            public SerializedDataEditorWindow Editor { get; private set; }
            public ClassDataListItem(SerializedDataEditorWindow editor, ClassData data)
            {
                this.Editor = editor;
                this.Data = data;
                LoadProperties();
            ...
            private void LoadProperties()
            {
                ...
                for (int i = 0; i < Data.Properties.Length; i++)
                {
                    ...
                    else if (Data.Properties[i].Type == PropertyType.Class)
                        property = new ClassPropertyDataListItem(Editor, (ClassPropertyData)Data.Properties[i]);
                    else if (Data.Properties[i].Type == PropertyType.Reference)
                        property = new ReferencePropertyDataListItem(Editor, (ReferencePropertyData)Data.Properties[i]);
            ...
            {
                ReferencePropertyData rd = new ReferencePropertyData();
                rd.Name = "NewValue";
                var property = new ReferencePropertyDataListItem(Editor, rd);
                _Properties.Add(property);
                RebuildProperties();
            }
        ...
        class SerializedDataListItem : ClassDataListItem
        {

            public SerializedDataListItem(SerializedDataEditorWindow editor, SerializedData data)
                : base(editor, data)
            { }
            ...
            {
                get { return ((SerializedData)Data).Namespace; }
                set { ((SerializedData)Data).Namespace = value; UpdateText(); }
            }

            [Skill.Framework.ExposeProperty(105, "Partial", "is partial class")]
            public bool Partial
            {
                get { return ((SerializedData)Data).IsPartial; }
                set { ((SerializedData)Data).IsPartial = value; }
            }
        ...
        abstract class PropertyDataListItem : Label, IListItem
        {
            ...
            public PropertyDataListItem(SerializedDataEditorWindow editor, PropertyData data)
            {
                this.Editor = editor;
                this.Data = data;
                UpdateText();
            ...
            [Skill.Framework.ExposeProperty(104, "Initial Value", "Initial value of property")]
            public string InitialValue
            {
                get { return Data.InitialValue; }
                set
                {
        ...
        class PrimitivePropertyDataListItem : PropertyDataListItem
        {
            ...
            public PrimitivePropertyDataListItem(SerializedDataEditorWindow editor, PrimitivePropertyData data)
                : base(editor, data)
            {
            }
            public override void UpdateText()
            {
                ...
                if (valueStr == "UInt") valueStr = v.SafeMemory ? "SafeUInt" : "uint";
                if (valueStr == "Long") valueStr = v.SafeMemory ? "SafeLong" : "long";
                if (valueStr == "ULong") valueStr = v.SafeMemory ? "SafeULong" : "ulong";
        ...
        class ClassPropertyDataListItem : PropertyDataListItem
        {
            ...
            #endregion
            public ClassPropertyDataListItem(SerializedDataEditorWindow editor, ClassPropertyData data)
                : base(editor, data)
            {
            }
            public override void UpdateText()
        ...
        class ReferencePropertyDataListItem : PropertyDataListItem
        {
            #region IProperties members
            public override string Title { get { return "ReferenceProperty"; } }
            #endregion
            public ReferencePropertyDataListItem(SerializedDataEditorWindow editor, ReferencePropertyData data)
                : base(editor, data)
            {
            }

            [Skill.Framework.ExposeProperty(104, "Class Name", "name of type include namespace")]
            public string ClassName
            {
                get { return ((ReferencePropertyData)Data).ClassName; }
                set { ((ReferencePropertyData)Data).ClassName = value; UpdateText(); }
            }

            [Skill.Framework.ExposeProperty(105, "Reference Type", "type of refrenced data")]
            public SerializableReferenceType Type
            {
                get { return ((ReferencePropertyData)Data).ReferenceType; }
                set { ((ReferencePropertyData)Data).ReferenceType = value;}
            }


            public override void UpdateText()
            {
                ReferencePropertyData c = (ReferencePropertyData)Data;
                ...
                if (c.IsArray)
                    base.Text = string.Format("{0}[] {1}", cn, c.Name);
                else
                    base.Text = string.Format("{0} {1}", cn, c.Name);
            }
            ...
            class ClassProperties : Properties
            {
                public ClassProperties(ReferencePropertyDataListItem item)
                    : base(item)
                {
                }
            }
        ...
        private SerializedDataListItem _SaveDataItem;
        [SerializeField]
        private SerializedDataAsset _Asset;
        private SerializedData _SaveData;
        public SerializedDataAsset Asset
        {
            get { return _Asset; }
            set
            {
        ...
        private SerializedData DefaultSaveData()
        {
            SerializedData saveData = new SerializedData();
        ...
        private void Rebuild()
        {
            ...
            if (_Asset != null)
            {
                ...
                _SaveDataItem = new SerializedDataListItem(this, _SaveData);
