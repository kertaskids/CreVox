    ...
    public class MeshExporter
    {
        ...
        private void MeshToString(MeshFilter mf, StringBuilder buffer)
        {
            ...
            for (int material = 0; material < m.subMeshCount; material++)
            {
                ...
                string matName = (materials[material] != null) ? materials[material].name : "none";
                buffer.Append("usemtl ").Append(matName).Append("\n");
                buffer.Append("usemap ").Append(matName).Append("\n");
