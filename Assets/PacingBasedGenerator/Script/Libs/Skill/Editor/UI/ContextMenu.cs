...
namespace Skill.Editor.UI
{
    ...
    public class MenuItem : MenuItemBase
    {
        ...
        public string Name { get { return _Content.text; } set { _Content.text = value; OnChanged(); } }

        /// <summary> Image </summary>
        public Texture Image { get { return _Content.image; } set { _Content.image = value; OnChanged(); } }

        /// <summary> Tooltip </summary>
        public string Tooltip { get { return _Content.tooltip; } set { _Content.tooltip = value; OnChanged(); } }
        ...
        public MenuItem(string name)
        {
            ...
            this._Content = new GUIContent() { text = name };
