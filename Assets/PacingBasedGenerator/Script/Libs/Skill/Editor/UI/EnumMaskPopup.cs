...
namespace Skill.Editor.UI
{
    ...
    /// </summary>
    public class EnumMaskPopup : EditorControl
    {
        /// <summary>
        ...
        protected override void Render()
        {
            ...
            if (Style != null)
            {
                Mask = EditorGUI.EnumMaskPopup(RenderArea, Label, _Mask, Style);
            }
            else
            {
                Mask = EditorGUI.EnumMaskPopup(RenderArea, Label, _Mask);
            }
        }
    }
}
