    ...
    public abstract class ExposeProperties : PropertiesPanel
    {
        ...
        private ControlProperties CreateProperties(PropertyType type, PropertyInfo info, ExposePropertyAttribute attribute)
        {
            ...
            switch (type)
            {
                ...
                case PropertyType.Double:
                    control = new DoubleProperties(this, info, attribute);
                    break;
        ...
        protected class FloatProperties : ControlProperties
        {
                ...
                : base(owner, attribute.Order, info)
            {
                ...
                _Field.Delayed = attribute.Delayed;
                _Field.Label.text = attribute.Name;
                _Field.Label.tooltip = attribute.Description;
            }
        ...
        protected class DoubleProperties : ControlProperties
        {
            public override PropertyType Type { get { return PropertyType.Double; } }

            private Skill.Editor.UI.DoubleField _Field;
            public override Framework.UI.BaseControl Control { get { return _Field; } }
            public DoubleProperties(ExposeProperties owner, PropertyInfo info, ExposePropertyAttribute attribute)
                : base(owner, attribute.Order, info)
            {
                _Field = new Skill.Editor.UI.DoubleField();
                _Field.ValueChanged += FloatField_ValueChanged;                
                _Field.Label.text = attribute.Name;
                _Field.Label.tooltip = attribute.Description;
            }
        ...
        protected class StringProperties : ControlProperties
        {
                ...
                : base(owner, attribute.Order, info)
            {
                ...
                if (attribute.PasteEnable)
                {
                    _PasteTextField = new PasteTextField(attribute.RightToLeft, attribute.TextArea);
                    _TextField = _PasteTextField.TextField;
                    if (attribute.TextArea)
                        _PasteTextField.Height = Mathf.Max(18, attribute.TextAreaHeight);
                }
                else
                {
                    ...
                    if (attribute.TextArea)
                    {
                        _TextField.Height = Mathf.Max(18, attribute.TextAreaHeight);
                    }
                }
        ...
        protected class SerializableObjectProperties : ControlProperties
        {
            ...
            private Skill.Editor.UI.VerticalExpander _Expander;
        ...
        protected class ArrayProperties : ControlProperties
        {
            ...
            {
                _Fields = new List<ControlProperties>();
                _SizeField = new IntField() { Value = 0, Delayed = true };
        ...
        private static void CreateTypes()
        {
                ...
                _Types = new TypeTag[]
            {
                ...
                new TypeTag(){ Type = typeof(double), PropertyType = PropertyType.Double},
            };
            }
        }
