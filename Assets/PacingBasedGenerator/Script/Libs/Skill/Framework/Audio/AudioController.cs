...
namespace Skill.Framework.Audio
{
    public class AudioController : Skill.Framework.DynamicBehaviour
    {
        ...
        /// <summary> set as true if AudioListener not paused when pausing game </summary>
            ...
            if (_CurrentState != null)
            {
                ...
                if (_CurrentState.NextState != null)
                {
                    ...
                    if (deltaTime > BufferTime)
                        _ScheduleNextStateTW.Begin(deltaTime, Realtime);
                    else
        ...
        private void ScheduleNextState(double deltaTime)
        {
            if (_CurrentState != null)
            {
                ...
                if (_NextState != null)
                {
                    _NextStateTW.Begin(fdeltaTime , Realtime);
        ...
        private void TransitBy(AudioTransition transition)
        {
            if (transition.Destination != null)
            {
                ...
                if (_NextState.Clip != null)
                {
                    ...
                    {
                        _UpdateNextStateTW.Begin(Mathf.Max(0, fdeltaTime - _ActiveTransition.FadeIn), Realtime);
