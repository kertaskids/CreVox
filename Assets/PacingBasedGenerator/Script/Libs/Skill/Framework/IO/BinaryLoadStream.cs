...
namespace Skill.Framework.IO
{
    ...
    public abstract class BinaryLoadStream
    {
        ...
        /// <summary>
        /// Read array of SafeUInt data from stream
        /// </summary>
        /// <returns>array of SafeUInt</returns>
        public SafeUInt[] ReadSafeUIntArray()
        {
            int length = ReadInt();
        ...
        /// <summary>
        /// Read array of SafeLong data from stream
        /// </summary>
        /// <returns>array of SafeLong</returns>
        public SafeLong[] ReadSafeLongArray()
        {
            int length = ReadInt();
        ...
        /// <summary>
        /// Read array of SafeULong data from stream
        /// </summary>
        /// <returns>array of SafeULong</returns>
        public SafeULong[] ReadSafeULongArray()
        {
            int length = ReadInt();
