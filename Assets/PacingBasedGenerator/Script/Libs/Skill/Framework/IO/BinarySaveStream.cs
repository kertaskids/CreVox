...
namespace Skill.Framework.IO
{
    ...
    public abstract class BinarySaveStream
    {
        ...
        /// <summary>
        /// Write given unsigned int value to stream
        /// </summary>
        /// <param name="i">value to write</param>
        ...
        /// <summary>
        /// Write given int64 value to stream
        /// </summary>
        /// <param name="l">value to write</param>
        public abstract void Write(long l);

        /// <summary>
        /// Write given unsigned int64 value to stream
        /// </summary>
        /// <param name="l">value to write</param>
        ...
        /// </summary>
        /// <param name="primitives">array of int value to write</param>
        public void Write(uint[] primitives)
        {
            int length = 0;
            if (primitives != null)
                length = primitives.Length;
        ...
        /// </summary>
        /// <param name="primitives">array of int value to write</param>
        public void Write(long[] primitives)
        {
            int length = 0;
            if (primitives != null)
                length = primitives.Length;
        ...
        /// </summary>
        /// <param name="primitives">array of int value to write</param>
        public void Write(ulong[] primitives)
        {
            int length = 0;
            if (primitives != null)
                length = primitives.Length;
        ...
        /// <summary>
        /// Write given array of SafeUInt value to stream
        /// </summary>
        /// <param name="primitives">array of SafeUInt value to write</param>
        public void Write(SafeUInt[] primitives)
        {
            int length = 0;
            if (primitives != null)
                length = primitives.Length;
        ...
        /// <summary>
        /// Write given array of SafeLong value to stream
        /// </summary>
        /// <param name="primitives">array of SafeLong value to write</param>
        public void Write(SafeLong[] primitives)
        {
            int length = 0;
            if (primitives != null)
                length = primitives.Length;
        ...
        /// <summary>
        /// Write given array of SafeULong value to stream
        /// </summary>
        /// <param name="primitives">array of SafeULong value to write</param>
        public void Write(SafeULong[] primitives)
        {
            int length = 0;
            if (primitives != null)
                length = primitives.Length;
