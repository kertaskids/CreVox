...
namespace Skill.Framework.IO
{
    ...
    public sealed class XmlLoadStream
    {
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>int</returns>
        public uint ReadUInt(XmlElement e)
        {
            string v = e.GetAttribute("Value");
            if (v != null)
            {
                uint i;
                if (uint.TryParse(v, out i))
                    return i;
            }
            return 0;
        }
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>int</returns>
        public long ReadLong(XmlElement e)
        {
            string v = e.GetAttribute("Value");
            if (v != null)
            {
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>int</returns>
        public ulong ReadULong(XmlElement e)
        {
            string v = e.GetAttribute("Value");
            if (v != null)
            {
                ulong i;
                if (ulong.TryParse(v, out i))
                    return i;
            }
            return 0;
        }
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>array of int</returns>
        public uint[] ReadUIntArray(XmlElement e)
        {
            string lenghtStr = e.GetAttribute("Lenght");
            int length = 0;
            if (!int.TryParse(lenghtStr, out length))
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>array of int</returns>
        public long[] ReadLongArray(XmlElement e)
        {
            string lenghtStr = e.GetAttribute("Lenght");
            int length = 0;
            if (!int.TryParse(lenghtStr, out length))
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>array of int</returns>
        public ulong[] ReadULongArray(XmlElement e)
        {
            string lenghtStr = e.GetAttribute("Lenght");
            int length = 0;
            if (!int.TryParse(lenghtStr, out length))
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>array of int</returns>
        public SafeUInt[] ReadSafeUIntArray(XmlElement e)
        {
            string lenghtStr = e.GetAttribute("Lenght");
            int length = 0;
            if (!int.TryParse(lenghtStr, out length))
                length = 0;
            SafeUInt[] array = new SafeUInt[length];
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>array of int</returns>
        public SafeLong[] ReadSafeLongArray(XmlElement e)
        {
            string lenghtStr = e.GetAttribute("Lenght");
            int length = 0;
            if (!int.TryParse(lenghtStr, out length))
                length = 0;
            SafeLong[] array = new SafeLong[length];
        ...
        /// <param name="e">XmlElement contains data</param>
        /// <returns>array of int</returns>
        public SafeULong[] ReadSafeULongArray(XmlElement e)
        {
            string lenghtStr = e.GetAttribute("Lenght");
            int length = 0;
            if (!int.TryParse(lenghtStr, out length))
                length = 0;
            SafeULong[] array = new SafeULong[length];
