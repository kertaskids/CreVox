...
namespace Skill.Framework.IO
{
    ...
    public sealed class XmlSaveStream
    {
        ...
        /// <param name="i">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, uint i)
        {
            XmlElement e = new XmlElement(propertyName);
            e.SetAttributeValue("Value", i.ToString());
            return e;
        ...
        /// <param name="i">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, long l)
        {
            XmlElement e = new XmlElement(propertyName);
            e.SetAttributeValue("Value", l.ToString());
            return e;
        }
        ...
        /// <param name="i">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, ulong l)
        {
            XmlElement e = new XmlElement(propertyName);
            e.SetAttributeValue("Value", l.ToString());
            return e;
        ...
        /// <param name="primitives">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, uint[] primitives)
        {
            XmlElement e = new XmlElement(propertyName);
            int length = 0;
            if (primitives != null) length = primitives.Length;
        ...
        /// <param name="primitives">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, long[] primitives)
        {
            XmlElement e = new XmlElement(propertyName);
            int length = 0;
            if (primitives != null) length = primitives.Length;
        ...
        /// <param name="primitives">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, ulong[] primitives)
        {
            XmlElement e = new XmlElement(propertyName);
            int length = 0;
            if (primitives != null) length = primitives.Length;
        ...
        /// <param name="primitives">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, SafeUInt[] primitives)
        {
            XmlElement e = new XmlElement(propertyName);
            int length = 0;
            if (primitives != null) length = primitives.Length;
        ...
        /// <param name="primitives">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, SafeLong[] primitives)
        {
            XmlElement e = new XmlElement(propertyName);
            int length = 0;
            if (primitives != null) length = primitives.Length;
        ...
        /// <param name="primitives">data to save</param>
        /// <returns>XmlElement containig data</returns>
        public XmlElement Create(string propertyName, SafeULong[] primitives)
        {
            XmlElement e = new XmlElement(propertyName);
            int length = 0;
            if (primitives != null) length = primitives.Length;
