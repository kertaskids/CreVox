...
namespace Skill.Framework
{
    ...
    public class IsometricCameraMotion : DynamicBehaviour
    {
        ...
        public void MotionFov(float finalFov, float motionTime)
        {
            ...
            {
                _Fov.Begin(Camera.Fov, finalFov, motionTime, Camera.IgnoreTimeScale);
                enabled = true;
            }
        }
        ...
        public void MotionAroundAngle(float finalAroundAngle, float motionTime)
        {
            ...
            {
                _AroundAngle.Begin(Camera.AroundAngle, finalAroundAngle, motionTime , Camera.IgnoreTimeScale);
                enabled = true;
            }
        }
        ...
        public void MotionLookAngle(float finalLookAngle, float motionTime)
        {
            ...
            {
                _LookAngle.Begin(Camera.LookAngle, finalLookAngle, motionTime, Camera.IgnoreTimeScale);
                enabled = true;
            }
        }
        ...
        public void MotionPreview(float finalPreview, float motionTime)
        {
            ...
            if (finalPreview != Camera.CameraPreview)
            {
                ...
                _Preview.Begin(Camera.CameraPreview, finalPreview, motionTime, Camera.IgnoreTimeScale);
                enabled = true;
            }
        }
        public void MotionZoomIn(float finalZoomIn, float motionTime)
        {
            ...
            if (finalZoomIn != Camera.ZoomIn)
            {
                ...
                _ZoomIn.Begin(Camera.ZoomIn, finalZoomIn, motionTime, Camera.IgnoreTimeScale);
                enabled = true;
            }
        }
        ...
        public void MotionZoomOut(float finalZoomOut, float motionTime)
        {
            ...
            if (finalZoomOut != Camera.ZoomOut)
            {
                ...
                _ZoomOut.Begin(Camera.ZoomOut, finalZoomOut, motionTime, Camera.IgnoreTimeScale);
                enabled = true;
            }
        }
        ...
        public void MotionCustomOffset(Vector3 finalCustomOffset, float motionTime)
        {
            ...
            if (finalCustomOffset != Camera.CustomOffset)
            {
                ...
                _CustomOffset.Begin(Camera.CustomOffset, finalCustomOffset, motionTime, Camera.IgnoreTimeScale);
                enabled = true;
            }
        }
