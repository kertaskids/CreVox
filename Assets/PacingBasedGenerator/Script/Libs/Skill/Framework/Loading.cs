...
namespace Skill.Framework
{
    ...
    public abstract class Loading : DynamicBehaviour
    {
        ...
        /// <summary> automatically active loaded scene when loaded </summary>
        public bool AutoActiveScene = true;
        ...
        protected override void Update()
        {
            ...
            if ((_LoadingAsyncOperation != null || TestMode) && !_ActivateSceneTW.IsEnabled && AutoActiveScene)
            {
                if (_Progress > 0.99f)
                {
