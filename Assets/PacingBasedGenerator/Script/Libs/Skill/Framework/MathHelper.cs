...
namespace Skill.Framework
{
    ...
    public static class MathHelper
    {
        ...
        {
            return FrameFrustumHeight(camera.fieldOfView, frustumHeight);
        }
        ...
        /// <param name="frustumHeight">Height of frustum</param>
        /// <returns>distance to camera</returns>
        public static float FrameFrustumHeight(float fieldOfView, float frustumHeight)
        {
        ...
        {
            return FrameFrustumWidth(camera.fieldOfView, camera.aspect, frustumWidth);
        }
        ...
        /// <param name="frustumWidth">Width of frustum</param>
        /// <returns>distance to camera</returns>
        public static float FrameFrustumWidth(float fieldOfView, float aspect, float frustumWidth)
        {
            float frustumHeight = frustumWidth / aspect;
            return frustumHeight * 0.5f / Mathf.Tan(fieldOfView * 0.5f * Mathf.Deg2Rad);
        }
        ...
        {
            return FrustumHeightAtDistance(camera.fieldOfView, distance);
        }
        ...
        /// <param name="distance">Distance to camera</param>
        /// <returns>height of frustum</returns>
        public static float FrustumHeightAtDistance(float fieldOfView, float distance)
        {
            return distance * Mathf.Tan(fieldOfView * 0.5f * Mathf.Deg2Rad) * 2.0f;
        }
        ...
        /// <param name="distance">Distance to camera</param>
        /// <returns>width of frustum</returns>
        public static float FrustumWidthAtDistance(float fieldOfView, float aspect, float distance)
        {
            return FrustumHeightAtDistance(fieldOfView, distance) * aspect;
        }
        ...
        {
            return OrthographicWidth(camera.orthographicSize, Screen.width, Screen.height);
        }
        ...
        /// Calculate width of orthogonal camera
        /// </summary>
        /// <param name="orthographicSize">orthographicSize</param>
        /// <param name="screenWidth">screenWidth</param>
        /// <param name="screenHeight">screenHeight</param>
        /// <returns> width of camera</returns>
        public static float OrthographicWidth(float orthographicSize, float screenWidth, float screenHeight)
        {
            return orthographicSize * screenWidth / screenHeight * 2;
        }
        /// <summary>
