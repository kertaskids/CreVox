...
namespace Skill.Framework
{
    ...
    public class Settings : Skill.Framework.IO.ISavable
    {
        ...
        public sealed class QualitySettings : Skill.Framework.IO.ISavable
        {
            ...
            private bool _PreDynamicShadow;
            ...
            /// <summary> Enable or disable dynamic shadow </summary>
            public bool DynamicShadow
            {
                get { return _DynamicShadow; }
                set
                {
                    if (_DynamicShadow != value)
                    {
            ...
            internal void CopyNewValues()
            {
                ...
                _PreBloom = _Bloom;
                _PreDynamicShadow = _DynamicShadow;
            ...
            private void CopyOldValues()
            {
                ...
                _Bloom = _PreBloom;
                _DynamicShadow = _PreDynamicShadow;
            ...
            public void ApplyChanges(bool applyExpensiveChanges = true)
            {
                ...
                Global.RaiseQualityChanged(this);
            }
            ...
            public void Save(IO.XmlElement e, Skill.Framework.IO.XmlSaveStream stream)
            {
                ...
                IO.XmlElement _DynamicShadowElement = stream.Create("DynamicShadow", _DynamicShadow);
                e.AppendChild(_DynamicShadowElement);
                ...
                while (element != null)
                {
                    switch (element.Name)
                    {
                        ...
                        case "Bloom":
                            ...
                            break;
                        case "DynamicShadow":
                            this._DynamicShadow = stream.ReadBoolean(element);
                            break;
                        case "RadialBlur":
            ...
            public void Load(Skill.Framework.IO.BinaryLoadStream stream)
            {
                ...
                this.DynamicShadow = stream.ReadBoolean();
                CopyNewValues();
                SetAsClean();
            }
