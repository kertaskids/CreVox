...
namespace Skill.Framework.Weapons
{
    ...
    public class Projectile
    {
        ...
        public int ClipAmmo { get { return _ClipAmmo; } set { _ClipAmmo = Mathf.Clamp(value, 0, ClipSize); } }
        ...
        public int Ammo { get { return _Ammo; } set { _Ammo = Mathf.Clamp(value, 0, MaxAmmo - ClipAmmo); } }
